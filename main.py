...
def main():
    ...
    def run_synch_dist_avg(rand_geo_gr, TOL):
    ...
    def run_asynch_dist_avg_W(rand_geo_gr, TOL):
    ...
    def run_asynch_dist_avg_noW(rand_geo_gr, TOL):
    ...
    def run_random_gossip_noW(rand_geo_gr, TOL):
        ...
        return error_rand_goss_noW

    def run_pdmm_synch(rand_geo_gr, TOL):
    ...
    def run_pdmm_async(rand_geo_gr, TOL):
    ...
    def run_pdmm_with_c(rand_geo_gr, TOL):
    ...
    def run_random_gossip_TF(rand_geo_gr, TOL):
    ...
    def run_pdmm_TF(rand_geo_gr, TOL):
    ...
    def run_comparison_random_gossip_TF(rand_geo_gr, TOL):
    ...
    def run_comparison_pdmm_TF(rand_geo_gr, TOL):
    ...
    # SYNCH DIST AVG
    # run_synch_dist_avg(rand_geo_gr, TOL)

    # ASYNCH DIST AVG
    # run_asynch_dist_avg_W(rand_geo_gr, TOL)
    # run_asynch_dist_avg_noW(rand_geo_gr, TOL)

    # RANDOM GOSSIP
    error_rg_noW = run_random_gossip_noW(rand_geo_gr, TOL)

    # PDMM with c = 0.4 and failure rate = 0.0
    # run_pdmm_synch(rand_geo_gr, TOL)
    # run_pdmm_async(rand_geo_gr, TOL)

    # CHOICE OF C IN PDMM
    # run_pdmm_with_c(rand_geo_gr, TOL)

    # TRANSMISSION FAILURES IN RANDOM GOSSIP
    # run_random_gossip_TF(rand_geo_gr, TOL)
    # run_comparison_random_gossip_TF(rand_geo_gr, TOL)
